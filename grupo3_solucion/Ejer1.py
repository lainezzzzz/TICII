def extraer_del_fichero_ejer1() -> list:
    ...
    # 1º Abrir el fichero
    fichero = open("C:/Users/diego/Desktop/Workspaces/TICII/Datos/malaga.csv", "r", encoding='utf-8')
    
    # 2º Leer el fichero
    lineas_del_fichero = fichero.readlines()
    
    # 3º Recorrer todas las líneas del fichero
    for linea in lineas_del_fichero:
        lista_datos = linea.split(",")
        
        diccionario_datos = {"id_alojamiento":lista_datos[0], "id_anfitrion":lista_datos[2], "distrito": lista_datos[5], "precio": lista_datos[9]}

        lista_alojamientos.append(diccionario_datos)
        
    # 4º Cerrar el fichero
    fichero.close()
